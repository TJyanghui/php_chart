...
$chart_png=mysql_query($ris[0][5]);
mysql_close();

$db2 = mysql_connect($host,$user,"fk@ipcdbserver");
...
// $myPicture->setFontProperties(array("FontName"=>"../fonts/simsun.ttc","FontSize"=>8,"R"=>255,"G"=>255,"B"=>255)); 
 ...
 $myPicture->setFontProperties(array("FontName"=>"../fonts/simsun.ttc","FontSize"=>6,"R"=>0,"G"=>0,"B"=>0)); 
...
//$filename="pictures/drawLineChart.plots".rand()."png";
